...
public class MyContentProvider extends ContentProvider {
    ...
    static final String DATABASE_NAME = "LIBRARYDB";
    static final String TABLE_NAME = "Library";
    static final int DATABASE_VERSION = 1;
    static final String PROVIDER_NAME = "com.example.library.provider";
    ...
    static {
        ...
        uriMatcher.addURI(PROVIDER_NAME, "Library", uriCode);
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case uriCode:
                return "com.example.library.provider/Library";
            default:
